...
public class task1_1_2 {
    ...
    public static class KeyMapper
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            word.set(getFileName(path.toString()));
    ...
    public static class KeyReducer
        ...
        public void reduce(Text key, Iterable<IntWritable> values,
            ...
            context.write(key, new IntWritable(doccnt++));
        }
    }

    public static void main(String[] args) throws Exception {
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, "hash doc id");
        job.setJarByClass(task1_1_2.class);
        job.setMapperClass(KeyMapper.class);
        job.setReducerClass(KeyReducer.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(IntWritable.class);
        job.getConfiguration().set("mapreduce.output.basename", "docid.mtx");
